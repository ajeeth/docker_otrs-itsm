...
#OTRS
RUN wget http://ftp.otrs.org/pub/otrs/RPMS/rhel/6/otrs-5.0.16-01.noarch.rpm
RUN yum -y install otrs-5.0.16-01.noarch.rpm --skip-broken
...
#Get ITSM module
RUN wget http://ftp.otrs.org/pub/otrs/itsm/bundle5/ITSM-5.0.16.opm
